...
public class FileController {
  ...
  /**
   * POST /api/files/upload/image Sube una imagen (avatar de usuario o carátula de canción).
  ...
  /**
   * POST /api/files/upload/audio Sube un archivo de audio (MP3). Requiere: Authorization: Bearer
   * <token>
   */
  ...
  /** GET /api/files/images/{filename} Sirve una imagen almacenada localmente. */
  ...
  /** GET /api/files/audio/{filename} Sirve un archivo de audio almacenado localmente. */
  ...
  private String resolveContentType(
      HttpServletRequest request, Resource resource, String fallback) {
    try {
      String contentType =
