...
public class UserController {
  ...
  /** Actualiza el perfil del usuario autenticado (nombre, avatar, posiblemente contraseña) */
  @PutMapping("/me")
  public ResponseEntity<UserProfileDTO> updateProfile(
      @AuthenticationPrincipal User user, @Valid @RequestBody UserUpdateDTO updateDTO) {
